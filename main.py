    ...
    def new_photo(self, instance):
       ...
       '''
        ...
        if i in self.dictionary:
           ...
           # print("fefjlslheriuhifarfjvfefjlslheriuhifarfjvfefjlslheriuhifarfjvfefjlslheriuhifarfjvfefjlslheriuhifarfjvfefjlslheriuhifarfjvfefjlslheriuhifarfjvfefjlslheriuhifarfjvfefjlslheriuhifarfjvfefjlslheriuhifarfjvfefjlslheriuhifarfjv\n\n\n\n\n\n\n\n\nfefjlslheriuhifarfjv")
           # print(self.dictionary[i])
        else:
            raise IndentationError

        bl2 = BoxLayout(orientation='vertical')
        bl2.add_widget(self.image)
